...
import (
	...
	"github.com/Ngoe-Gaiel/go-trip-api/internal/api"
	"github.com/Ngoe-Gaiel/go-trip-api/internal/persistence"
...
func run() error {
	...
	psqlInfo := fmt.Sprintf("host=%s port=%d user=%s password=%s dbname=%s sslmode=disable",
		...
		fmt.Print("database connection string:: ", psqlInfo)
	...
	fmt.Printf("after initializing service layer..")
